...
<html>
	...
	<body bgcolor="#D3D3D3">
		...
		<div class="adauga">
			<a class="menu_checked" href="admin_panel.php">Adauga</a>
			...
			<form class="adauga" method="POST">
				<label>Nume&nbsp;&nbsp;&nbsp;</label>
				<input class="text" type="text" name="name" title="Nume"></input>
				<label>Pret&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
				<input class="pret" type="text" name="pret" title="Pret"></input>
				<label>Image&nbsp;&nbsp;&nbsp;</label>
				<label class="image_file" for="image_file" name="image" title="Imagine">Incarca imaginea</label><br>
				<input id="image_file" type="file" name="image" hidden></input>
				<label>Tip&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
				...
				<input class="submit" type="submit" name="adminAdauga" value="Adauga"></input>
			</form>
		</div>
	</body>
